...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        self.infoLabel.backgroundColor = [UIColor clearColor]; self.infoLabel.textColor = [UIColor blackColor];
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    CGSize s = [self.infoLabel.text sizeWithAttributes:attributes];
    s.height += 15;
    s.height += SHADOWSIZE;
