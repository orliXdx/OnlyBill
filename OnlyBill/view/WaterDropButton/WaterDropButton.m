...
#define WaterDropButtonBorderWidth (2.f)

@interface WaterDropButton ()
...
@implementation WaterDropButton
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _animateTap = YES;
        _borderSize = WaterDropButtonBorderWidth;
...
- (void)triggerAnimateTap {
    ...
    circleShape.opacity = 0;
//    circleShape.strokeColor = self.borderColor.CGColor;
    circleShape.strokeColor =  [[UIColor colorWithRed:135/255.f green:206/255.f blue:250/255.f alpha:1.0] CGColor];
    circleShape.lineWidth = 2.0;
